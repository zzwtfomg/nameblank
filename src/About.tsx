    ...
    <>
      ...
      <div className="flex flex-col items-center justify-center min-h-screen pt-24 p-10">
        <div className="text-center max-w-2xl menlo font-light">
          <p className="text-lg mb-8">Hi I'm Zeke and I like to make clothes that actually feel like something. Two years ago I realized there was nothing I owned or could buy that felt like me, so I taught myself how to sew and pattern draft.</p>
